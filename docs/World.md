...
- **[Caria](World/Caria.md)** (southwest): green and temperate — **Yorrem**, capital of the Gleaners Guild, where the previous campaign began; **Oldspire** and the dig called **the Void**, where the Aura network came back on; the underwater city **Oceana** off its far coast; and **Titans Rest**, the Titan Fighters' tree fort, in its highlands.
