...
| **Beyond-Ce** | **A backstory, as of the 2026-09-21 export:** not a hero and not interested — a practical, paid **escort and guide** who gets people where they're going, asks few questions, and doesn't abandon clients. *"If Beyond-Ce agrees to get you somewhere, you will probably get there."* The export cuts off mid-text at a section called "The Road." Other narrative fields still blank. | Not on the board — Andy was the DM. | The rest of the backstory (ask Andy for the full text); which faction the Faction Agent background means. |
