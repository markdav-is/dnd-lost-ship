...
| **The Purge.** Orbital incendiary strike sterilizes the valley today | Copper ("Do it. Do it now, before we talk ourselves out of it.") | Irreversible; ship technology lost; the valley dead a generation; must be certain nothing spread beyond the radius — and **it does not address Rajaat**. "You are not curing anything. You are only removing the second outbreak." |
