...
| 2 — Classes | Barbarian (Pit Fighter, Wilder) · Cleric (**Air/Earth/Fire/Water elemental domains**) · Druid (**Circle of Preservation** — official UA Preserver chassis) · Fighter (**Gladiator** — swapped to the official UA 2025 subclass, see below; Warlord) · Monk (Way of the Unseen Mind) · **Psion** (full class: Egoist, Telepath, Nomad, Kineticist, Seer) · Ranger conclaves · Rogue · **Athasian Bard** · Wizard (**Arcane Defilement**, Ecomancer, Arcanamach) |
