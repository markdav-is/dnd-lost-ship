...
The great cities of Vermoon each carry an elemental theme — legacies of the age when the [Titans](/World/The-Titans) powered civilization — and are linked by an ancient teleportation network the party reactivated in the previous campaign.
...
- **Parked at Eustace's homeland** — [Eustace](/Campaign/The-Party/Eustace-Thunderbeak) landed it there for a hero's welcome among his people.
- Runs on fuel that [Rico](/NPCs/Rico) the engineer worked out how to synthesize; supply is plentiful.
- Home of the **Silver (or White) Dragon** ([The Dragons](/World/The-Dragons)).
