...
> *The metal doors slide open with a hiss, revealing a long, curving walkway suspended above a vast open chamber… From somewhere deeper in the deck, you hear a soft mechanical whir — and then nothing but the distant hum of ancient engines.*

## Design intent

A gauntlet blending horror, tension, and dark comedy. The deck is built around **light attraction**, slow creeping movement, and stacked grapples. Players should feel watched, hunted, and unsure whether the technology will help or kill them. Wandering checks are deliberately rare (1-in-20/turn) because the fixed hazards are brutal.
...
Roper gullets: 2d12 gems each (10 gp), 2 dud grenades, fire extinguisher, platinum wire (1,600 gp), **anti-grav belt**. Dining servo: jet black + **violet cards** (the way down), empty needler, 3 jewelry pieces (1,000–4,000 gp each).
...
- **Lingering 3–6 min** → extra 1-in-6 the dining servo comes seeking diners.
