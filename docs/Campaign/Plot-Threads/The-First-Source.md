...
What actually keeps Rajaat in check is the Deep Desert's engineered ecology:
...
The ship is a **second Rajaat** — sitting in a valley full of trees, animals, rivers, and people. Spores never need to mass (life everywhere to attach to); there are no worms to close the loop. *"Your desert does not exist yet. And creating one large enough would take generations and kill everything between here and the sea."*
