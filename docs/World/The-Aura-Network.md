...
- Real-time perception-sharing: what a connected node sees and decides feeds the network's collective memory.
...
- **The void.** The ship's hyper-dimensional properties render it completely invisible: no scrying, no network perception, no teleport/ethereal/astral inside. This is why Jak needed the party. *(If the party mounts Eddie's dish — [The Antenna](../Adventures/Return-to-the-Ship/The-Antenna.md) — the ship gains a voice on the network through an external hard-wired antenna aimed at the Temple of Nord: Eddie joins as a user, the ship can make and take calls through him, and Jak can talk in. The link is to the ship itself, not a tower — phones still do not work aboard or near it. The network still cannot see, scry, or teleport inside.)*
...
| State | Effect |
| :--- | :--- |
| Connected | Cannot be surprised; advantage on Perception; telepathy with connected Spásistren within 1 mile |
| Severed | Advantage vs. mind-affecting effects; undetectable by scrying for 1 hour |
| Spásistren implants | Immunity to charmed and frightened |
