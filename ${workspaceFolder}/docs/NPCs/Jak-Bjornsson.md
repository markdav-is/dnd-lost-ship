...
- He is not a villain. He is a good man holding absolute power, which may be worse. Whether the crown corrupts him — or whether [something rides his network](/Campaign/Plot-Threads/The-Invisible-Infection) — is the campaign's long question.

## Secrets & levers

- The **sealed orders**: once the party's mission ends, the Spásistren are to seal the ship, leaving Jak exclusive access to the extracted data ([Tomas Vel-Maret](/NPCs/Tomas-Vel-Maret) has a copy).
- [Nordkrist's Hold](/Campaign/Plot-Threads/Nordkrists-Hold) is his project; he has not told the party what it is.
