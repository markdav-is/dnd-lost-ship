...
| 2 — Classes | Barbarian (Pit Fighter, Wilder) · Cleric (**Air/Earth/Fire/Water elemental domains**) · Druid (**Circle of Preservation** — official UA Preserver chassis; **on Aerun this is the [Gleaners Guild's](../World/Aerun.md) practice**, and "preserver" means a Gleaner who casts) · Fighter (**Gladiator** — swapped to the official UA 2025 subclass, see below; Warlord) · Monk (Way of the Unseen Mind) · **Psion** (full class: Egoist, Telepath, Nomad, Kineticist, Seer) · Ranger conclaves · Rogue · **Athasian Bard** · Wizard (**Arcane Defilement**, Ecomancer, Arcanamach) |
...
- **No granted spells.** The templar's god-given magic does not exist here. A character who wants the *state-sanctioned caster* niche should look at the setting's own arcane roads instead: the Wizard's **Arcane Defilement** tradition — the defiler's art, kept in oath-form by the [Order of the Sere](../World/Factions/The-Order-of-the-Sere.md) — or the **Ecomancer**, the restorer's road the [Gleaners](../World/Aerun.md) quietly cultivate (see *Rejuvenate*, below). Elemental-domain Clerics cover the priestly flavor. No new mechanics needed; the subclasses already exist in Chapter 2.

## Arcane Defilement (the core mechanic)

From 1st level, **any wizard can choose to defile** as part of casting a wizard spell of 1st+ level — stripping the land's life to ash for **defiler points** (spent like sorcery points on metamagic: Careful, Distant, Empowered, etc.).

**Defiler points by terrain:**

| Points | Terrain |
| :-: | :--- |
| 0 | Desolate — dust basins, salt flats, silt sea |
| 1 | Barren — mountains, badlands, sandy/stony wastes |
| 2 | Verdant — oases, savannah, scrub plain, verdant belt |
| 3 | Forest — abundant vegetation |
...
## Gladiator (Fighter) and Circle of Preservation (Druid) — official UA swaps

The table has adopted two subclasses from `assets/UA2025-ApocalypticSubclasses.pdf`, replacing or supplementing the AthasCon Players Guide originals because they're officially published and D&D-Beyond-enterable — the same preference for published content over homebrew the Great Schools page states for the Psion subclasses.

**Gladiator (Fighter)** replaces the AthasCon homebrew Gladiator outright: Brutality (bonus weapon-mastery effects on a hit), Combat Theatrics, Flourish Parry (reaction AC boost + counterattack), Bolder Brutalities, Brutal Resurgence, Mutilate at 18. Arena-flavored, and it fits the Bloodsand Arena / pit-fighter material already in the campaign.

**Circle of Preservation (Druid)** is new, not a replacement — the official chassis for Preservers (see [Harah Tabr](../NPCs/Harah-Tabr.md) for it in play): Preserved Land (a moving cube of restorative ground), Improved Preservation, Facilitated Restoration (free Lesser/Greater Restoration), Sacrosanct Land at 14. It sits alongside the Arcane Defilement section above as preserving's answer to defiling — same dichotomy, opposite mechanic.
...
- Backgrounds double as faction hooks: **Veiled One** → the [Gleaners](../World/Aerun.md) (Aerun's preservers — play it as *Gleaner*); **Former Bureau Officer** → the city bureaus and the families they serve; **House Agent** → [the merchant houses](../World/Factions/The-Merchant-Houses.md).
