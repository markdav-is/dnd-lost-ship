[Home](Home.md) / Aerun Players Guide <!-- wikidown:breadcrumb -->

# Aerun Players Guide

*Everything a traveler may know about the desert continent — and nothing they shouldn't.*

**Every page in this section is player-facing and spoiler-free.** It is written to be handed out whole — the folder, not the page. The DM's material lives under [World](World.md) and [Campaign](Campaign.md); nothing here depends on it and nothing here gives it away.

## How these pages work

Each page opens with **What everyone knows** — common knowledge, no roll required; a traveler picks it up on the Ring Road whether they want it or not. Below that is a **Lore check** table by DC:

| DC | What it is |
| :-: | :--- |
| 10 | What a well-traveled person knows |
| 15 | What the well-read or the well-connected know |
| 20 | What a scholar, a factor, or a School graduate knows |
| 25 | **Rumor.** Whispered at the fire's edge. The DM decides which, if any, are true |

Which check to roll:

- **Intelligence (History)** — institutions, the Houses, the Guild, and the past.
- **Wisdom (Insight)** — reading a person in front of you: a Stillwater, a Kenaz-sworn, a blue-eyed stranger.
- **Intelligence (Arcana)** — how the Way actually works.
- **Wisdom (Survival)** — the land, the roads, the water, and the silt.

**Aerun natives, and anyone with a wild talent, roll with advantage on Aerun lore.** A success reveals every entry at that DC and below; if several are available, the DM picks.
...
## Ways to use the lore at the table
...
## Rules for Aerun characters

The player-facing rules pages live with the rest of the game mechanics:

- **[Dark Sun 5e Rules](Game-Mechanics/Dark-Sun-5e-Rules.md)** — races, the Psion, Arcane Defilement, wild talents.
- **[Psionics and the Great Schools](Game-Mechanics/Psionics-and-the-Great-Schools.md)** — entrance requirements, the Will and Way table rules, and D&D Beyond setup for a School graduate.
