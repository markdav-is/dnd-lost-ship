...
| :--- | :--- | :--- |
| **The Emperor** | **[Jak](../../NPCs/Jak-Bjornsson.md)** — the world's one king, in the south: **the Administrator** | The [Aura network](../The-Aura-Network.md), a **Spáhus** (the Spásistren's watch-house — not a temple) in every city, the Spásistren — and a deliberately light hand on Aerun |
...
- **Altaruk** — fortified caravan fort on the southern Ring Road between Balic and Amber Valley; 15-ft walls, 500 mercenaries; jointly held by Wavir and two client houses; quietly a **Gleaners haven** — its commander is a Gleaner and it keeps a G4CE office (defilers barred at the gate).
...
- **Carry everyone or no one.** The Guild serves all seven families, Jak's Spáhuses, and any coin that meets the rate. Refusing one customer means the customer-refusing precedent — so it never does, and never has to.
...
- **The Gleaners** *(the books' "Veiled Alliance")* — on Aerun the preservers are not a secret society of their own but the local chapter of Vermoon's **[Gleaners Guild](../Factions/The-Second-Age-Guilds.md)**: *take only what the land can spare* practiced as magic (the **Circle of Preservation**), working toward restoration. **Not hunted by the Houses** — they are Aerun's planetologists (the Kynes role from *Dune*): they teach the Ring Road to grow crops, in the open, and hold a vision of turning Aerun back to a Green Age. Chapter hall in Balic, G4CE offices in Balic and Altaruk. Natural allies of any cure — and the quiet keepers of the **Avangion** road. See [Aerun](../Aerun.md).
