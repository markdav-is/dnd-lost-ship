...
The fungal infection has colonized the frozen bodies and **merged them into a single, interconnected organism**. The individual bodies twitch and reach toward the party as the hoversled passes.

## Creature (Shambling Mound + modifications)
...
Deeply unsettling rather than mechanically complex — describe **individual faces visible within the fungal mass**, frozen expressions of terror. In the scattered supplies, a journal; the last entry:
