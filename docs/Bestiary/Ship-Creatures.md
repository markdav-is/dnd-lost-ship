...
| Creature | CR | Note |
| :--- | :-: | :--- |
| **Webbirds** | ⅛ each | Swarm webs scale with numbers; egg implantation (2d4/hour until cured); alcohol dissolves webs |
| **Intellect Devourer** | 2 | One still between decks wearing the captain's old body-thief trail; senses thought at 300 ft |
| **Couatls ×4** (caged) | 4 | Celestial allies-in-waiting; will hunt the intellect devourer if freed |
| **Doppelgangers ×9** | 3 | Drop-tube ambush pack |
| **Displacer beasts, shadows, will-o'-wisps, gray oozes, phase spiders (dwarf), green slime** | ½–3 | Level 1 wanderers; wisps lure to radiation zones; slime drops from doorways |
| **Leechoids** | 1 | Hallucinogenic anesthetic — victims lie down for 3 hours while draining |
| **Scintillating fish** | — | Touch = DC 15 CON or die; scales are gems (5 gp × 55–100) |
| **Baboonoids** | 1 | Grenade-throwing troop; 20% parley; potential scouts |
| **Shambling mounds ×2, black pudding, quipper swarm, lizardoids, gasbats, slithering trackers** | 1–5 | Garden/lower-deck ecosystem |

## DM patterns

- The menagerie doesn't coordinate — but the mold is starting to network parts of it. An escaped creature (the cloaker precedent) is a ready-made "the ship is leaking" beat.
- Lure-predator-lure chains: globe palm scent → predators; squealer's distress calls → rescuers; the bunny path → the maw. The garden *hunts by kindness*.
