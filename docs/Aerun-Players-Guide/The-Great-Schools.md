[Home](../Home.md) / [Aerun Players Guide](../Aerun-Players-Guide.md) / The Great Schools <!-- wikidown:breadcrumb -->

# The Great Schools of Aerun — A Traveler's Primer

*What everyone on Vermoon has heard, what the well-read know, and what is whispered — set down for players.*

**How to use this:** this page is **player-facing and spoiler-free** — what a traveler could learn on the Ring Road, and what a scholar or a sharp-eyed observer could add to it with a good roll. Hand it out freely, alongside [Aerun — A Primer](Aerun-A-Primer.md) and the [Gazetteer](Gazetteer.md). The DM's version, with the Schools' secrets and full skill trees, is [The Great Schools](../World/Factions/The-Great-Schools.md); the rules for playing a graduate are on [Psionics and the Great Schools](../Game-Mechanics/Psionics-and-the-Great-Schools.md).
...
- There are **five Great Schools**. They train the mind — "the Will and the Way" — not magic, and they answer to no House. A School master is the most respected person in any city, consulted at namings, contract-swearings, and deathbeds.
- Their names, and what people say of each:
...
Roll **Intelligence (History)** for the Schools as institutions, **Wisdom (Insight)** for reading a graduate standing in front of you, or **Intelligence (Arcana)** for how the Way actually works. Aerun natives, and anyone with a wild talent, roll with advantage. A success reveals every tidbit at that DC and below; if several are available, the DM picks which to share.

### DC 10

| DC | Tidbit | School |
| :-: | :--- | :--- |
| 10 | Any child, freeborn or pit-born, who shows the Will may be tested by a School; the pits send their promising young on their masters' coin. It is the one ladder that reaches all the way down. | All |
| 10 | The Sisters serve a House by contract, never by birth — a Stillwater placed with a House is on loan, and can be recalled. | Stillwater |
| 10 | A Reckoner dismissed from one House may never serve a rival. Everyone knows this rule; everyone knows it is broken. | Reckoning |
| 10 | Crag-sworn are hired by every House; Balic buys most of them. [Urik](Gazetteer/Urik.md) runs its own, harsher Crag, and the two branches have not spoken in a generation. | Crag |
...
| 10 | The Guild takes children for the Lodge, pays the families, and does not explain. Graduates are not released. | Lodge |

### DC 15

| DC | Tidbit | School |
| :-: | :--- | :--- |
| 15 | The Schools test for two things: the **Will** (stamina of mind; Aerunites say it lives in the body) and the **Way** (the learned technique). "Strong Will, quick Way." A student with one and not the other learns theory, or learns nothing. | All |
| 15 | Masters who push past exhaustion "burn the Will" — it is why every Master looks ten years older than they are. Heavy Spice users (blue-within-blue eyes) can push further; it costs them in other ways. | All |
| 15 | The Sisters' first teaching: a still surface reflects everything. The "Voice" is real — a Stillwater can make you halt, approach, or drop what you hold, and the truthtrance means you cannot lie to one who is looking. | Stillwater |
...
| DC | Tidbit | School |
| :-: | :--- | :--- |
| 20 | The Sisterhood's ancestor-order were the *Villichi* convents of the old books — rural retreats of psionic women that still exist under that name in the back-country. | Stillwater |
| 20 | The Crag is named for an old mental-combat construct of the Way — the Tower, the Rampart, the Gate, the Crag: "lonely and strong, resists all attacks." Mindbenders still use those words. | Crag |
| 20 | A Reckoner's graduation exercise is to memorize a full set of House books — *a different House's* from the one that paid their tuition. | Reckoning |
| 20 | Every Reckoner has a "Solido" — the trick of standing, speaking, and walking so exactly like their House's lord that a decoy is half-made before any Sister lends them the rest. | Reckoning |
| 20 | Nibenay's Sisterhood keeps the city's memory: it is said the Shadow King's court cannot remember what the Sisters decline to let it. | Stillwater |
...
| 20 | The Lodge also trains the argosy pilots — the mekillot-bonded minds of the Ring Road. Pilots and navigators are the heaviest Spice users on the continent. | Lodge |
...
| DC | Tidbit | School |
| :-: | :--- | :--- |
| 25 | They say the Sisterhood keeps a ledger of every House's bloodlines — not for a prophecy, but to predict which lines throw Spice-strong children. The Houses would kill for it. | Stillwater |
...
| 25 | They say the Lodge has a standing order: the Long Reach never bends northwest. Navigators do not know why, and have never asked. | Lodge |
| 25 | They say Urik's Crag is quietly building a curriculum in pure force for Stel's legions. | Crag |
...
## For players making a School character

Each School is one published subclass, chosen at level 3; nothing is homebrewed.

| School | Class and subclass |
| :--- | :--- |
| The Stillwater Sisterhood | Psion — **Telepath** |
| The School of Reckoning | Fighter — **Psi Warrior** |
| The Crag | Rogue — **Soulknife** |
