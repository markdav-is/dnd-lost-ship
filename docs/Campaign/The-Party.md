...
| :--- | :--- | :--- | :-: | :-: | :--- |
| [Shhhmeowmeow](The-Party/Shhhmeowmeow.md) | Shhhmeowmeow | Tabaxi Ranger 11 | 17 | 92 | **Nine Lives Stealer Longbow**, laser pistol; paired with the **Black Dragon**; the fire city under Eldorado is a backstory thread |
...
| **Beyond-Ce** | **Full backstory (Andy, 2026-09-22):** a practical, paid **escort and guide** who doesn't leave people behind — and a **shadow sorcerer by accident**: a night in the woods when the fire went out, a thing that swallowed light, a moment *outside*, something that *noticed* her, and a black hound that looks at her as if it knows her. *"She may not be a hero. But she does not leave people behind."* Other narrative fields still blank. | Not on the board — Andy was the DM. | Which faction the Faction Agent background means; the Collar of the Beast; what noticed her (Andy's to answer). |
| **Robin** | Faith (Chauntea), personality/ideal/bond/flaw, the med-bay note — and now a **full backstory (Bella, 2026-09-22):** a farm kid who wanted to heal, learned that healing costs money, fell in with road thieves to pay for it, and was turned out by her temple for it — still genuinely confused why. A cleric for hire with a *"questionable relationship with the concept of stealing."* | Not on the board — new this campaign. | Where the farm was; whether she ever goes back. |
...
- **All level 11** — matching the QftIS milestone track (level 13 by the module's end).
- **The party can fly** (Eustace natively; others via magic) — the modules assume aerial play and punish landing.
- **One cleric now** (Robin 8/Rogue 3): the [Counteragent](../Game-Mechanics/The-Counteragent.md) pin-and-dose meta has one professional — and **[Rejuvenate](../Game-Mechanics/Dark-Sun-5e-Rules.md)** left with Gobbledegook; Harah has it.
- **Session-note aliases:** "Musty Joe" = Musty-Jo Mustang; "Meow Meow" = Shhhmeowmeow; "Beyonce" = Beyond-Ce; "Hera/Hara" = Harah Tabr (transcriber spellings).
- Andy (Beyond-Ce's player) is the world's creator-DM and keeper of Aerun lore — the remaining **[ANDY LORE]** gaps are his to fill. See [The Green Age](Plot-Threads/The-Green-Age.md) and the interview in `/assets`.
