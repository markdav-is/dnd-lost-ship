...
- This is the **player-facing option set** for any Aerun-native character, companion NPC (Kaelen's tribe, house agents), or a PC rebuild for the desert arc; the DM-side rules chassis remains `DarkSun_5e_Campaign_Guide_v1.9.pdf` and the monster manual `DarkSun_5e_Terrors_of_the_Desert_v1.0.pdf` ([Sourcebooks](../Reference/Sourcebooks-and-Inspiration.md)).
