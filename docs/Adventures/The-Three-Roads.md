...
## Road 1 — Fire: the Airlantis Purge (rescue first)

*The certain answer. Everything burns — but not before everyone the party loves is out.*
...
Everything the ship and the network can field, compressed by a countdown. The purge is the *easiest road to start* and the *most expensive to finish* — and a partial burn (interrupted run, sabotage, weather) leaves burned-but-alive horrors, the worst of all worlds.

---

## Road 2 — Ash and Green: the Defiler Compact (defile, then restore)

*The proven answer — made survivable, for the first time in history, by a restoration step Aerun never had.*

### Structure

1. **The reconciliation.** The Sere will not talk to [Harah](../NPCs/Harah-Tabr.md) — her rift is real, unexplained, and must be crossed. The party brokers the meeting (travel to the Order, likely with the Sandwalker delegation as escort), hears the long story at last, and negotiates the compact. This is the social module: the undertakers must be convinced to work *under supervision, with a restoration plan* — a dignity they've never been offered.
2. **The great working.** Sere casters ring the valley at anchor-sites; the party **defends the henges** while the defiling proceeds — and the mold throws *everything*, because per [First Source](../Campaign/Plot-Threads/The-First-Source.md) canon, this is the one thing that has ever killed it. It remembers. Multi-site hold-the-point action, the module's combat core.
3. **The gray hours.** The spores and flora die; the infected *creatures* survive and starve ([Order of the Sere](../World/Factions/The-Order-of-the-Sere.md)). Mercy work: evacuations ahead of the ash line, cure-doses for the recently transformed if any serum exists, and the hardest fights — things that were people, out of time.
4. **The restoration (the redeeming act).** The twist Aerun never had: **the ark is a terraforming vessel.** Its garden level is a biosphere seeder; its hydroponics, seedbanks, and soil systems — plus **Rejuvenate** ([canon](../Game-Mechanics/Dark-Sun-5e-Rules.md)) from Veiled-Alliance-style casters and a level-9 Gobbledegook — replant the valley behind the defiling. Built-in irony to play hard: the party must **protect the ship's garden systems from the defiling itself**, or lose the restoration engine. Defile at dawn; replant by machine and spell.
5. **After the green.** The valley dies and is reborn inside a season. The Sere are transformed — undertakers into gardeners, their thousand-year oath finally completed *well*. And Aerun watches: a successful defile-restore is the **proof-of-model for healing the Deep Desert** — the wardens' first real hope. Rajaat is still uncured; the Lighthouse stands cleansed but intact; the ship survives.

### Threat profile

Front-loaded social risk (the rift, the compact), then the heaviest sustained combat of any road (the working + the gray hours). Failure modes: a broken henge (partial defiling — mosaic of dead and infected land), the Sere's trust collapsing mid-work, restoration sabotaged.

---

## Road 3 — The Cure (current direction)
...
- **The operation as set-piece:** run it like a boss fight that is also a medical drama —
  - **The team:** a willing defiler (the rift again — or a bold arcane PC learning the forbidden art), [Robin](../NPCs/Robin.md) and Gobbledegook on restoration/stabilization, Erleena directing, George *narrating his own surgery* in dry baritone.
...
Keep all three roads warm. Whatever the table chooses, foreshadow the other two (the Sere's ultimatum clock, Airlantis's shadow in every negotiation, the cure's honest uncertainty) — and let the Erleena Pivot braid them. Decision-space reference: [The Lighthouse Dilemma](../Campaign/Plot-Threads/The-Lighthouse-Dilemma.md).
