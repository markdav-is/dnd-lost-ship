...
| Code | Title | Year | Category | In library |
| :--- | :--- | :--- | :--- | :--- |
...
| 2446 | Psionic Artifacts of Athas | 1996 | Accessory | [DriveThruRPG](https://www.drivethrurpg.com/en/product/17208) |
...
None in the library. Archive.org lending copies exist for most: [Prism Pentad search](https://archive.org/search?query=prism+pentad+denning) · [Tribe of One search](https://archive.org/search?query=simon+hawke+dark+sun) · [Chronicles of Athas search](https://archive.org/search?query=chronicles+of+athas).

| Series | Books | Author(s) |
| :--- | :--- | :--- |
| Prism Pentad | The Verdant Passage (1991), The Crimson Legion (1992), The Amber Enchantress (1992), The Obsidian Oracle (1993), The Cerulean Storm (1993) | Troy Denning |
| Tribe of One | The Outcast (1993), The Seeker (1994), The Nomad (1994) | Simon Hawke |
| Chronicles of Athas | The Brazen Gambit (1994), The Darkness Before the Dawn (1995), The Broken Blade (1995), Cinnabar Shadows (1995), The Rise and Fall of a Dragon King (1996) | Lynn Abbey, Ryan Hughes, Simon Hawke |
| 4e-era | City Under the Sand (2010), Under the Crimson Sun (2011), Death Mark (2011) | Jeff Mariotte, Keith R.A. DeCandido, Robert J. Schwalb |

## Video games & other

| Title | Year | Notes | Link |
| :--- | :--- | :--- | :--- |
| Dark Sun: Shattered Lands | 1993 | SSI PC RPG | [GOG bundle](https://www.gog.com/en/game/dungeons_dragons_dark_sun_series) |
| Dark Sun: Wake of the Ravager | 1994 | SSI PC RPG | same GOG bundle |
| Dark Sun Online: Crimson Sands | 1996 | MMORPG, servers defunct | — |
| Dark Sun: Ianto's Tomb | 2011 | 5-issue IDW comic (Alex Irvine) | — |

## Fan-made 5e conversions (in library)

| Title | In library |
| :--- | :--- |
| Dark Sun Player's Guide — AthasCon 5E V2.1 | ✅ [PDF](../../assets/Dark%20Sun%20Players%20Guide%20-%20Athascon%20V2.1.pdf) (+ [text extraction](../../assets/DarkSun_Players_Guide_Athascon_V2.1.md)) |
| Dark Sun 5e Campaign Guide v1.9 | ✅ [PDF](../../assets/DarkSun_5e_Campaign_Guide_v1.9.pdf) |
| Dark Sun 5e — Terrors of the Desert v1.0 | ✅ [PDF](../../assets/DarkSun_5e_Terrors_of_the_Desert_v1.0.pdf) |

## On the horizon

**Dark Sun: Blood and Power** (player guide, new Psion class) and **Dark Sun: Edge of Oblivion** (DM setting guide) — announced at Gen Con 2026 for a 2027 release under the 2024 5e rules, D&D's first mature-rated (18+) products, plus a Map Pack and DM Screen. Coverage: [athas.org](https://athas.org/articles/dark-sun-2027).

---
*Inventory checked against `/assets` on 2026-08-12. Product codes verified against [Wikipedia's Dark Sun product list](https://en.wikipedia.org/wiki/List_of_Dark_Sun_modules_and_sourcebooks) and TSR catalog archives; note the 24xx code block interleaves novels with game products.*
