...
Journey-and-council module: the hoversled descent through dying mountains, the occupied hold, and the Council of Frostwatch. Tone: cosmic horror, political tension, impossible choices — *"The party has seen the void. Now the void is following them home."* Source: **`assets/Return_to_Frostwatch_Final.md`** (the current revision, which adds McReady's council role; the older docx lacks it).
...
**Seating:** [Valerius](/NPCs/High-Sister-Valerius) (implant pulsing), [Copper](/NPCs/Copper-the-Surgeon), [Elder Brennan](/NPCs/Elder-Brennan), the stranger [Kaelen al-Hajra](/NPCs/Kaelen-al-Hajra) (knife placed handle-forward, watching the doors), and — in the current revision — [McReady](/NPCs/McReady), who intercepts the party in the corridor ("Let me do the talking for the first minute"), introduces everyone, and tells Valerius: **"I'll vouch for all of them."**
...
4. **The Three Paths** with scripted responses from every voice at the table (including Kaelen's Aerun testimony and McReady's single line of "context": *"Jak would want the ship intact if possible. That's not an order."*). Full breakdown: [The Lighthouse Dilemma](/Campaign/Plot-Threads/The-Lighthouse-Dilemma).
5. **The question:** *"You have been there. What is your counsel?"*
6. **Codas:** Valerius marks Kaelen's network-invisibility ("I may need that"); the invisible-infection warning ("Sleep well."); McReady's dis-trans bat confrontation if the party pushes.
