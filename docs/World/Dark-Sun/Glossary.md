...
| **Raam** | On the shore of the interior silt — the **gateway to the coastal silt basin** | Noble toll-lands carving up every road; palace on a grassy knoll ringed by breastworks; the most chaotic city on the ring | ~40,000 (largest) | Poorly led but vast — the armory can arm *every citizen* |
| **Draj** | On a **huge mudflat at the edge of an inland silt basin** — reachable only by a stone-paved causeway | Fertile mud makes it the ring's breadbasket: **hemp and grain**; a 200-ft stone pyramid rises over the arena | ~15,000 | Harpoon-and-rope captive-takers, constantly raiding |
...
| **Balic** | Where the **Forked Tongue Estuary** — a silt estuary breaking through the Rim Wall — meets the southern ocean coast: a city between two seas, approachable by land only from the west | Olive orchards and grain farms; scrub plains 20 miles west for herd-grazing; the agora ringed by the Elven Market; **giants wade ashore from the estuary to raid** | ~24,000 | Universal militia — every citizen serves one month in ten |

**The source maps** (extracted from the PDFs — every landmark below is findable on these):

![The Tyr Region — Wanderer's Journal map (2e boxed set)](../../.attachments/darksun_tyr_region_2e.jpg)
...
![The Tyr Region — 4e edition](../../.attachments/darksun_tyr_region_4e.jpg)
...
- **The Forked Tongue Estuary** — the silt-arm reaching toward Balic; giant-infested islands in its channels.
- **Altaruk** — fortified trade village at the head of the estuary's Big Fork; 15-ft walls, 500 mercenaries; jointly held by Wavir and two client houses; quietly a **Veiled Alliance haven** (defilers barred at the gate).
...
- **The Sea of Silt** — the continent's heart: an ocean of powder-fine gray dust, the residue of the Green Age defiling — and it lies **below the ocean**: the silt surface sits roughly **600 feet under sea level** (the basin is the continent's murdered heart-sea, a Dead Sea-style depression), rising and falling tens of feet with the wind seasons. The arms run shallower: the **Draj mud-shelf** at about −100 ft, the **Raam arm** near −400 ft, the **Forked Tongue Estuary** near −300 ft. Flows like water, drowns like water; crossed only by Guild silt-crawlers and the Sandwalkers' secret shoals. **Silt horrors** hunt beneath the surface; the **great worms** swim its deeps and eat the Spice-cycle's dead spores.
- **The Veil** — the wardens' great working: the **deeper places of the Sea of Silt are psionically hidden** from every approaching mind. Fly directly over the First Source and you perceive only empty gray; expeditions cross the deeps and remember crossing nothing. Sight contests sight — massed disciplined minds blur what any single mind can see ([The First Source](../../Campaign/Plot-Threads/The-First-Source.md)).
- **The Rim Wall** — the cliffs where the living coast ends and the silt begins; beyond it the [Aura network fails](../The-Aura-Network.md). **Realistic profile:** the coastal ring climbs gently from the ocean to the rim crest (typically **+300 to +600 ft** above sea level) — then the inner face drops **~1,000 sheer feet** to the silt below (the same drop as the Dragon's Bowl; the high southern and western stretches fall closer to 2,000). Standing on the crest, the gray is *down* — a sunken second sky. Every road, hoist, and portage that touches the silt is an engineering answer to that drop.
- **The Tablelands / Badlands** — the broken transitional country behind Nibenay and Gulg; stony barrens behind Tyr and Urik.
- **Why the silt stays dry (the hydrology)** — three layers. *Rain shadow:* like the Atacama beside the Pacific, the coastal ranges and Rim Wall wring every ocean wind dry on the seaward slopes — which is why the coastal ring is green (the mountains harvest the whole continent's rain for the coast) and the interior gets none. *The haze dome:* the silt makes its own weather — a vast hot dust plain throws up a permanent particulate haze that suppresses rainfall outright (droplets cannot form in that much dust); storms that crest the wall rain a brief crust of mud at the basin's edge and die. *The containment:* the deep layer — **water is the spore vector** (the Green Age walls fell to spores in the groundwater), so the working made the basin endorheic and the dryness self-maintaining: the silt swallows moisture into dead strata, and a **larval stage of the great worms sequesters** what penetrates the deeps. The dryness is not climate; it is the quarantine's outermost wall ([The First Source](../../Campaign/Plot-Threads/The-First-Source.md)). Corollary the wardens never explain: **wetting the interior at scale is a containment breach**, and rare rain-years are **bloom years** — which the coast experiences only as bumper Spice harvests.
- **The Spice** — the worms' gift and the silt-cycle's product; ambient exposure grants **wild talents** (psionics); heavy use stains the eyes blue-within-blue and opens deeper doors ([conversion rules](../Dark-Sun.md)). The true engine of the [First Source's](../../Campaign/Plot-Threads/The-First-Source.md) containment — a secret the wardens keep absolutely. **An Aerun-only phenomenon** — the southern empire has never tasted it. The Guild's crews are steeped in it; the families sell it; nobody but the wardens knows what it *is*.
