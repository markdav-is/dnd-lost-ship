...
*(First survey.)* **[Erleena Riser](../NPCs/Erleena-Riser.md)** — alive, suit intact, found straining at the hatch wheel. *"Well. I'll be damned. You're a long way from home."*

## Below the Lighthouse: Erleena's Lab, then the stair down

Fifty feet beneath the lake surface: a 30-ft circular chamber, 10-ft ceiling. On the first survey it was cold stale air and blue-green emergency light; since Eddie restored power it is a bright, clean **sickbay** — white light, biobeds, wall displays ([Beneath the Lighthouse](../Adventures/Return-to-the-Ship/Beneath-the-Lighthouse.md)). Wide, riveted submarine-style viewports look into murky green water (AC 13, 10 HP each; a broken window floods the chamber at 1 ft/round) — the lake's small infected fauna batter the glass around the clock, and it holds; a froghemoth is another matter. If the froghemoth lives, three glowing eyes watch from the dark. Through a sliding door is her **workroom** (bench, dish, culture plates); through a hatch, her quarters.

- **Erleena's lab sits in the sealed levels directly beneath the Lighthouse** — intact seals, the lake as a natural spore shield: the perfect control environment, directly beneath the heaviest spore concentration. She is synthesizing a cure here: for George, and for everyone infected — and she lives here, in the old crew quarters off the lab, in the cream-and-orange medical uniform the ship made her; the containment suit is gone ([her page](../NPCs/Erleena-Riser.md)). (George's own lab is separate — up on the observation deck; see [his page](../NPCs/George-Decay.md).)
- **The cycling door:** the stairwell continues down; the access door at the bottom is supposed to be sealed but **has been cycling open and closed** since before the party's first visit — she asked them to make it stay shut, and it didn't work. The reason is mechanical: the door's **control station is on the lower-deck side, and its override is jammed at LOCAL** — Eddie can see the fault and can't clear it from his end. Someone has to go down to the cargo-bay control booth and turn the dial. Side quest: [The Jammed Override](../Adventures/Return-to-the-Ship/The-Jammed-Override.md). The stair comes out at the **southern edge of the [Lower Deck](The-Lower-Deck.md)** — a door the DM added off the published map, and one the party already knows — on the same deck as the stasis chamber ([The Ship's Purpose](../Campaign/Plot-Threads/The-Ships-Purpose.md)).
