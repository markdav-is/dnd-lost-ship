[Home](../../Home.md) / [Adventures](../../Adventures.md) / [Return to the Ship](../Return-to-the-Ship.md) / The Jammed Override <!-- wikidown:breadcrumb -->
...
The station is on the other side of the door. Two ways to reach it:

1. **Through the door, on its cycle.** The door opens every few hours and stays open about a minute — Erleena has the timing in her notes to within ten minutes, a month of listening to it grind. Wait on the stair; when it opens, go. **DEX save DC 13** to be clear of the frame before it seals (a fail is 2d6 bludgeoning and a shove back onto the stair, not a crushing). An Immovable Rod in the track holds it — Musty-Jo has one — and so does **STR 18** on the door, for one round.
2. **The long way, from the lower deck.** The party's old route: down through the reactor core (S61) and the decon corridors (S63), then south to the edge of the deck and the door they remember. The lower deck's cleanup operation is still running — roll the deck's random encounters as written ([The Lower Deck](../../The-Lost-Ship/The-Lower-Deck.md)) — and the wheely sleds in S63 are still there.

Either way the lower deck is spore-thick around the stair; a spore-blaster buys a minute of clean air where it's pointed.
...
- Erleena's request from the first survey, closed. If she's still on the ship when it happens, she notices the silence before anyone tells her.
- Eddie's **favor** ([The Lab at S42](The-Lab-at-S42.md)) — clearing the froghemoth or restoring power to a dark section were his two asks; unjamming a door he's been unable to close for a month counts, and he says so.
- A held route down. Whether the party uses it now or later, it's theirs.
