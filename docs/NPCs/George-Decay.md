[Home](../Home.md) / [NPCs](../NPCs.md) / George Decay <!-- wikidown:breadcrumb -->
...
Entered the ship a month before the party with [Erleena Riser](Erleena-Riser.md); both were exposed. George chose **chemistry** — an experimental drug cocktail synthesized from the ship's pharmacopeia that slowed the infection and kept his mind razor-sharp while golden-brown fungal growths ate him alive (≈30% of his body, at the party's first visit). Erleena chose **physics** — the containment suit. **Since then, he's had a breakthrough:** with Eddie's computational help running search space he couldn't cover alone, he refined the cocktail into a genuine anti-fungal treatment — not a stimulant that just keeps him functional, a real regression. The growths have receded to roughly half what they were (≈15% of his body now), and his strength is climbing back with them. He knows he isn't cured. He refuses to be boring about the distance still ahead of him either.

## The chemistry

George's road is chemistry, and it is working. Two products so far, and he is not modest about either:

- **The doses.** His anti-fungal treatment — halts progression for 24 hours, doesn't reverse a stage. The thing that keeps you alive long enough to be cured ([Russet Mold & Infection](../Game-Mechanics/Russet-Mold-and-Infection.md)).
- **The spore-blaster.** A backpack rig he built from the ship's old fire extinguishers: tank on the back, hose and wand in hand, charged with his alkaline mold-killer under pressure. A blast clears spore fog, burns fungus, and — the part he is proudest of — strips the active spore coat off an infected creature, which breaks its bond with the Lighthouse for a day. Worn like a firefighter's pack. The party will inevitably make the Ghostbusters joke; let them. Full stats: [The Counteragent](../Game-Mechanics/The-Counteragent.md).
...
![George, half-cured, washing a caged rabbitoid with a spray pack — the demonstration at S42](../.attachments/enc_s42_demonstration.jpg)
...
*A first-rank mind in a failing body, and a body that's finally winning some ground back. His spells are half arcana, half ship-tech jury-rigging — nobody at the table can tell where one ends. Party-parity CR 8 while the body holds.*

**AC** 12 (15 with *shield*) · **HP** 68 — recovering as the infection recedes; a healthy George would have 77, and he's most of the way there · **Speed** 25 ft · STR 8, DEX 12, CON 12, **INT 20**, WIS 16, CHA 14 · **Saves** INT +9, WIS +7 · **Skills** Nature +13, Medicine +11, Arcana +9, Investigation +9 · **Resists** poison · reads ship language (limited)
...
![George at the reunion, half-cured, holding up a dose](../.attachments/george_portrait_s42.jpg)

**George's own lab is S42, Medical Storage, on the observation deck's north-west rim — two doors west of the north drop tube (S31), past the S32 robot station (QftIS Map 7.2, p.177)** — separate from Erleena's beneath the Lighthouse; see [Level 2 — The Theater](../The-Lost-Ship/Level-2-The-Theater.md) for the rest of the deck. It grew out of his old base in the garden crew room (S50): his drug-synthesis rig fed by the medical systems, ship instruments on the consoles, a month of notes on the mold. Since Eddie woke the room looks the way the ship was built to look ([the *Space: 1999* rule](../The-Lost-Ship.md)): cream panels, flat white light, orange trim, a low white console under the rig, a worker robot wiping benches. The notebooks are the only clutter, and George defends them. He picked the room for what was already in it — shelves of the ship's medical stock to feed the rig, and a yellow-tier door that stays shut to anything without a card — and he has held it for a month by learning the ring around it: the growths at S38b (north: razorvine blocking the rail) and S38c (west: three ropers) wall his pocket off from the rest of the ring in both directions, so nothing walks to his door along the rail; his early warning is Eddie's sensors and the lit run from the north tube, and there are doors on this ring he has learned never to open, starting with the whirlpools next door and the pool beyond them. His standing advice to visitors, delivered without looking up from the bench: *"From the tube, follow the lights and stop where they stop. The doors past that point are not locked. That is rather the problem."* (This lab's network sessions were part of George and Erleena's deliberate, joint effort to wake Eddie for cure research and communication — see [Return to the Ship](../Adventures/Return-to-the-Ship.md).) He and Erleena stay apart not by choice: the Lighthouse is still producing spores, and the Garden Level between his deck and her lab is thicker with them now than it was on the party's first pass — a hazard, not a rift.
...
Knows: the card system, the mold's lifecycle (21–24h transformation; burn or dissolve the dead), ship history, safe routes through Levels 1–3, the garden's flora rules, the Horrid Plant, the froghemoth's existence. The observation deck's ring: which rooms are dark and why (the grells in the whirlpools, the aboleth in the pool, the androids still dancing in the club, the lounge robots who will seat you and take a dinner order at any hour), and that Eddie keeps the run lit from the north drop tube to his door. Does **not** know: the wolf-in-sheep's-clothing, the squealer's lair, the froghemoth's full capabilities (it's alive, infected, and working for the Lighthouse now).
...
- **Saved — and this is the one that happens:** a cure (Erleena's baseline work on Aerun, the surgery on the ship) makes him a permanent ally and ship-tech interpreter.
