...
> 3. **The central mesa (high):** rising from the middle of the green ring, **steep terracotta cliff walls climb ~2,000 feet** on every side to the tabletop. **The mesa's outline is deliberately irregular and lobed — never a smooth oval or circle.** Its defining feature is **the Prong**: a vast blunt promontory of plateau thrusting **southeast between Raam and Balic**, pushing the cliff wall far out toward the eastern ocean so the green band there is squeezed into a narrow, strongly *curved* corridor — the **Crescent Forest bends around the Prong's cliffs** (Nibenay at its northern horn, Gulg in the belly of the curve), and the Ring Road must bow east with it. **Do not let the eastern coast and the silt edge run parallel in a straight line from Raam to Balic** — the Prong breaks that line. **The tabletop is the Sea of Silt: featureless matte bone-gray dust, dead flat, with faint wind-ripples and slow spiral storm textures.** Label the gray plain "THE SEA OF SILT" and the cliff ring "THE RIM WALL."
>
