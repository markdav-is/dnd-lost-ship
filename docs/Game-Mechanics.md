[Home](Home.md) / Game Mechanics <!-- wikidown:breadcrumb -->

# Game Mechanics

Campaign-specific rules the table returns to every session.

- [Russet Mold & Infection](Game-Mechanics/Russet-Mold-and-Infection.md) — exposure, stages, treatment, transformation.
- [Key Card System](Game-Mechanics/Key-Card-System.md) — the ship's color-coded access hierarchy.
- [Alien Technology](Game-Mechanics/Alien-Technology.md) — weapons, belts, grenades, vehicles, and power.
- [Cold & Survival](Game-Mechanics/Cold-and-Survival.md) — Frostwind Crossing hazards and frostbite.
- [Heat & Survival](Game-Mechanics/Heat-and-Survival.md) — the Aerun desert mirror: water rings, heatstroke, and how the party's races handle it.
