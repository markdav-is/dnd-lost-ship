...
1. **The Emperor — Jak**, the king in the south — **the Administrator**: the network, a Spáhus in every city, the Spásistren, and a deliberately light hand. Aerun is his wildest, least-controlled continent, and he leaves it alone **because it is the trading hub of the world**. There are no kings on Aerun; there is a king in the south.
...
The habitable coastal strip: seven great family-ruled cities controlling Vermoon's global commerce — the shipping hubs between the northern continents (**Taldea** and **Malandara**), the Scarlands, and the other landmasses — linked by the **Ring Road**, the continent-circling highway where the Guild's argosies carry the bulk goods teleporters cannot. Jak keeps a small **Spáhus** in each city — the house of the [Spásistren](Factions/The-Spasistren.md), and the embassy of the southern Emperor; they watch, they do not rule. (*Spáhus*: "seeing-house," the sisters' own word; plural *Spáhuses*. They are Jak's **outposts in the world** — the one true temple is the Temple of Nord in Grønnfjord. A Spáhus is a guard house and a network post, **not a temple** — there is no worship in it and no god. The Ring Road mostly calls it *Jak's watch-house*.)
...
- **The high stretches — the western spine:** the **Ringing Mountains run the length of the west coast**, from the northwestern lobe above Tyr down past Osgaker, Hollowstorm, and Eldorado to Urik in the southwest, merging with the rim wall the whole way. Their crests tower **+4,000–6,000 ft**, *well above the silt plateau behind them*: true mountains with the dead sea lapping at their inland shoulders. Iron at the northern end, obsidian and the smoking **Black Crown** at the southern, gold hidden at Walis in between. On the east, the **Badlands** massif does lesser work behind Nibenay and Gulg.
...
- **The Southern Sweep — the wall follows the coast down to Balic:** the mesa is not a tidy oval, and it does not throw out square peninsulas. Instead, from Raam the **rim wall curves southeast and then south in one long graceful arc**, running roughly parallel to the eastern coast — a **sweeping shoulder of highland** that keeps the living band narrow all the way down the eastern shore before bending west to reach **Balic**. The Crescent Forest fills that corridor between wall and sea, which is exactly why it is a crescent: **Nibenay** near its northern end, **Gulg** in the belly of the curve, the rust-red **Badlands** stepping down from the wall's flank. The Ring Road follows the same sweep — no detour, just the road bending with the land.
- **The wall's height falls as it goes south.** The rim is at its most brutal in the north and west (sheer, unclimbable, backed by the mountains); along the southern sweep it **loses height steadily**, breaking into stepped benches and long scree ramps; and where it reaches **Balic** it has come down to the **Balic Saddle — only two or three hundred feet above the coastal plain**, a broad shallow notch where the silt spills over in a wide ramp and a city can work cargo up and over on its own stairs. **Balic exists because the wall finally lets someone across.**

### The winds — why the interior is dead

**Vermoon's prevailing winds blow from the west, always.** They come off the open ocean heavy with moisture, strike the **Ringing Mountains** along the west coast, and are forced up 4,000–6,000 feet — dumping everything they carry on the seaward slopes. That rain is the whole reason the western coastal ring is green: **Tyr's verdant valley, Hollowstorm's fisheries, and Urik's irrigated plantations drink water that never reaches the interior.** What crosses the crest descends hot, dry, and starving, and by the time it is over the plateau there is nothing left in it. Everything downwind — the entire Sea of Silt, and the eastern cities in its lee — lives in that shadow: Nibenay pumps its water up from hot springs, Gulg gathers instead of farming, and Raam has exhausted its reservoir. A low gap like the Balic Saddle changes none of this: one notch cannot re-wet a continent, and the saddle sits on the lee side regardless. *(The deeper reasons the interior stays dry — the haze dome and the containment working — are on [The First Source](../Campaign/Plot-Threads/The-First-Source.md); the wind is merely the visible one.)*
...
Behind the wall, the interior is the **Sea of Silt**: the bed of the Green Age's highland heart-sea, unmade in the defiling — a continent-heart ocean of powder-fine gray dust at **~+1,800 ft**, dry because it is high, higher than everything except the mountain crests. It flows like water, drowns like water, and swallows everything heavier than a Guild silt hull. Violent silt-storms, absolute water scarcity, entirely off the grid.

- **The Long Reach — the silt lane:** the Guild's marked shipping lane from the **Raam Shelf** in the northeast to the **Balic Crest** in the south — **~350 miles, 5–6 days by skimmer convoy**, against two to three tendays hauling the same freight the long way round the ring. Its traffic is skimmers and long haulers — people and light goods; bulk freight stays on the Ring Road. It is staked end to end with bone-and-obsidian channel markers and served by three waystations on the firmest shoals — **First Mark**, **Midreach**, **Saltbone** — with harvest sidings branching toward the Spice shoals. It holds to the **eastern and southern reaches** and never bends northwest. Full details: [Ecology of the Silt Sea](Dark-Sun/The-Silt-Sea.md).
...
Arcane magic on Aerun draws on the life force of the land. **Preservers** take only what the flora can recover from. **Defilers** rip life out wholesale, turning soil to sterile ash; **the ascended Champions are the defiling art's apex** — the Dragon state is the defiler-psion metamorphosis walked to its end, and the ascended's centuries of feeding helped scour the Tablelands. Arcane magic is feared and often illegal in the cities — punishable by death or enslavement. See [The Order of the Sere](Factions/The-Order-of-the-Sere.md) for how this connects to the Green Age containment and the Scarlands crisis; deep source: *Defilers and Preservers* ([library](Dark-Sun.md)).

**The preservers are the Gleaners (canon, 2026-09-21).** Dark Sun's secret preserver network, the *Veiled Alliance*, does not exist on Aerun under that name. Its place is filled by something the rest of Vermoon already has: the **[Gleaners Guild](Factions/The-Second-Age-Guilds.md)** — the Second-Age faction whose whole creed is *take what is needed and no more, and put back what you can*. On Aerun that creed is not a policy; it is a magical discipline. **The Gleaners' practice is the Circle of Preservation** ([rules](../Game-Mechanics/Dark-Sun-5e-Rules.md)), and "preserver" is simply what Aerun calls a Gleaner who casts. **They are Aerun's planetologists** — the Dune analog is exact: Kynes and his ecological stations, not an underground. **The Houses do not hunt them.** The Gleaners work in the open, **teaching the Ring Road how to grow crops** — seed, soil, windtraps, what to plant where and when to leave a field alone — and they hold, openly, **a vision of transforming Aerun back to a Green Age**, a project they measure in generations and nobody else measures at all.

## The Second-Age guilds on Aerun

Aerun is ruled by its seven families and moved by the Transit Guild, but it is still part of Vermoon, and three of the four [Second-Age guilds](Factions/The-Second-Age-Guilds.md) keep a footing here. To avoid confusion: on Aerun **"the Guild" always means the Transit Guild.** The outland guilds go by their short names — *the Gleaners, the Tinkers, the Fettered Mind* (never "the Academy" — on Aerun that is the Navigation Academy).

| Guild | On Aerun | Where to find them |
| :--- | :--- | :--- |
| **The Gleaners** | The continent's preservers and its planetologists: they **teach the Ring Road to grow crops**, keep demonstration plots and seed stores, survey wells, and carry a long vision of a **green Aerun**. **Not hunted, not hidden** — a House with better harvests has more to sell, so the Gleaners are welcome at every gate. Aerun still fears arcane magic, so they bond their components at the gate like everyone else and let the fields speak for the casting. | A chapter hall in **Balic**'s Guilders' Precinct (where the guilds vote); the **commander of Altaruk** is one of theirs, and the fort turns defilers away; nursery gardens at **Hollowstorm**, the wettest ground on the continent. **And a door in most cities, under the names the Dark Sun maps give to temples:** the **Gleaners' Quarter** in Raam (the books' Temple Quarter), the **Sun Garden** in Nibenay (the Temple of the Sun — a walled, terraced teaching garden), the **Seed Hall** in Draj's Two Moon City (the Father and Master Temple), beside the Fields of Plenty. |
| **G4CE** ("G-Force") | The Gleaners' guard, exactly as elsewhere in Vermoon. **The party's G4CE medallions are good here**: an office will recognize them, put them up, and has contract work. Mostly caravan-field protection, well disputes, and escorting seed. | Offices in **Balic** (beside the chapter hall) and at **Altaruk**; a one-room post at **Hollowstorm**. Nothing inland of the Rim Wall. |
| **The Tinkers** (Tinkerers of Thingamajigs) | Aerun has almost no metal and an ocean of buried Antari salvage, which makes it the most frustrating and most interesting posting a Tinker can draw. They buy, identify, and repair old-world finds. | The salvage yards at **Osgaker** (the yardmasters who "know what everything is"); the trinket tables of **Eldorado**, where half the "ancient" pieces were made last tenday by a Tinker with a straight face. |
| **The Fettered Mind** (Academy of the Fettered Mind) | **A full academy, in Balic** — the one chartered school of arcane magic on the continent. Aerun fears magic, and a faction whose whole creed is the *restraint* of magic is the only kind of wizard it will license: Balic's Chamber granted the charter on the understanding that the Fettered Mind teaches control first and casting second, keeps its components under seal, and answers for every mage under its roof. A library, lecture halls, guest rooms for visiting faculty, and a seat among Balic's voting guilds. It is small beside the psionic **[Great Schools](Factions/The-Great-Schools.md)**, which hold on Aerun the place the Academy holds elsewhere. **Naming:** on Aerun "the Academy" already means the *Navigation* Academy in Raam, so this one goes by **the Fettered Mind**. **It is [Erleena's](../NPCs/Erleena-Riser.md) foothold on Aerun**: she is a professor of the Academy, on leave — she has colleagues there, a bed, a bench, a library, and somewhere to send a box of books. | The **Guilders' Precinct, Balic**, near the Gleaners' chapter hall. |
| **The Devout Coalition** | **Absent.** There are no gods on Aerun, no temples, and no priests; the Coalition has nothing to oversee and has never opened a door here. Where other lands raise temples, Aerun raises schools. | — |

*Mark's ruling: at least one Academy of the Fettered Mind in a major city, as Erleena's foothold — placed in Balic. The rest of the placement is Claude's, from the gazetteer as it stood — Balic's voting guilds, Altaruk's preserver commander, Hollowstorm's green, Osgaker's yards, Eldorado's tables. Move any of it freely.*
...
![Notebook — the concentric rings](../.attachments/aerun_notebook_rings.jpg)
![Notebook — naming the cities](../.attachments/aerun_notebook_cities.jpg)
