...
| Hit Points (average) | `186` |
| Hit Points (dice) | `12d20 + 60` |
| Speed | `30 ft.` |
| STR | `26 (+8)` |
| DEX | `6 (-2)` |
| CON | `21 (+5)` |
...
## Token art prompt
"Circular fantasy creature token, top-down three-quarter bust view of a mountain-sized hauling lizard, an immense dome-shelled saurian like a walking mesa, tiny black eyes lost in folds of cracked leathery hide, a vast blunt mouth with a long pink tongue coiled at its lip, shell and hide in weathered ash-gray and bone with rust-streaked plate ridges, cargo cables and an argosy harness scaffold anchored to its shell, sun-bleached Dark Sun desert palette, harsh desert sunlight, dark neutral background, centered, high detail digital painting, no text, no border."
